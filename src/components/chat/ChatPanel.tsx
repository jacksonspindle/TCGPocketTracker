...
export default function ChatPanel({ cards, sets }: ChatPanelProps) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed right-0 top-0 h-full w-full max-w-md bg-gray-900/70 backdrop-blur-2xl border-l border-white/10 shadow-2xl z-50 transform transition-transform duration-300 ease-out ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          {error && (
            <div className="px-4 py-3 bg-red-500/20 border-t border-red-500/20 backdrop-blur-sm">
